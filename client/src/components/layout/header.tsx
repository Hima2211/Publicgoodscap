...
export default function Header() {
  ...
  return (
    <header className="bg-darkBg border-b border-darkBorder sticky top-0 z-50">
      {/* Mobile header (CoinMarketCap/CoinGecko style) */}
      <div className="md:hidden">
        {/* Top bar with logo and wallet button */}
        <div className="flex justify-between items-center px-4 py-3 border-b border-darkBorder">
          ...
          <div className="flex items-center space-x-2">
            <Button 
              variant="ghost" 
              size="icon" 
              className="h-8 w-8 rounded-full bg-darkCard border border-darkBorder"
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full bg-darkCard border border-darkBorder">
